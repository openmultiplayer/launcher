export default {
  ...
  add_server_modal_description_1:
    "Voeg handmatig een server toe aan de favorietenlijst.",
  ...
  server_join_prompt_enter_password:
    "Deze server is beveiligd, voer een wachtwoord in.",
  ...
  remove_selected_server_from_favorites:
    "Geselecteerde server uit favorieten verwijderen",
  add_selected_server_to_favorites:
    "Geselecteerde server aan favorieten toevoegen",
  ...
  settings_gta_path_input_label: "Locatie van GTA: San Andreas installatie",
  browse: "BLADEREN",
  settings_import_nickname_gta_path_from_samp:
    "Nicknaam en GTA: SA locatie importeren uit SA-MP-instellingen",
  settings_import_samp_favorite_list:
    "Favorietenlijst importeren uit SA-MP-gegevens",
  settings_reset_application_data:
    "Applicatiegegevens resetten (wist instellingen en lijsten)",
  settings_new_update_available:
    "⚠ Nieuwe update beschikbaar. Klik om te downloaden! ⚠",
  ...
  gta_path_modal_cant_find_samp_description_2:
    "Kies een andere versie of download en installeer SA-MP handmatig.",
  add_or_play_external_server: "Toevoegen aan favorieten of spelen",
  reconnect: "Opnieuw verbinden",
  settings_advanced_discord_status_requires_restart:
    "(Opnieuw starten van het spel vereist om Discord status up te daten)",
  ...
  export_no_servers_description:
    "Je hebt geen favoriete servers om te exporteren.",
  ...
  export_failed_description:
    "Er is een fout opgetreden bij het exporteren van je favoriete servers.",
  ...
  import_failed_description:
    "Er is een fout opgetreden bij het importeren van je favoriete servers.",
  import_invalid_data_description:
    "Het geselecteerde bestand bevat ongeldige gegevens. Selecteer een geldig favorietenlijstbestand.",
};
