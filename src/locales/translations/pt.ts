export default {
  ...
  server_join_prompt_nickname_input_placeholder: "Digite o Apelido...",
  connect: "Conectar",
  copy: "Copiar",
  ...
  settings_import_nickname_gta_path_from_samp:
    "Importar apelido e caminho gtasa das configurações do SA-MP",
  ...
  settings_new_update_available: "⚠ Nova atualização disponível. Clique para fazer o download! ⚠",
  settings_credits_made_by: "Feito com ❤️ por",
  settings_credits_view_source_on_github: "Veja o código-fonte no GitHub",
  ...
  download: "Baixar",
  update_modal_remind_me_next_time: "Me lembre na próxima vez",
