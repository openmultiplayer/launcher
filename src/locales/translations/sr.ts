export default {
  ...
  play: "Играј",
  remove_selected_server_from_favorites: "Уклони из Омиљених изабрани сервер",
  ...
  settings_gta_path_input_label: "Путања до GTA: San Andreas",
  browse: "Претражи",
  ...
  settings_new_update_available:
    "⚠ Нова верзија доступна. Кликните за преузимање! ⚠",
  ...
  gta_path_modal_path_not_set_title:
    "Путања до GTA: San Andreas није подешена!",
  ...
  export_failed_description:
    "Дошло је до грешке приликом извоза омиљених сервера.",
  ...
  import_failed_description:
    "Дошло је до грешке приликом увоза омиљених сервера.",
  import_invalid_data_description:
    "Изабрани фајл садржи неважеће податке. Молимо изаберите важећи фајл листе омиљених.",
  settings_custom_game_exe_label: "Назив прилагођене извршне датотеке игре",
  unable_to_find_custom_game_exe_title:
    "Није могуће пронаћи прилагођену извршну датотеку игре!",
  unable_to_find_custom_game_exe_description:
    "Наведена прилагођена извршна датотека игре није пронађена у директоријуму GTA: San Andreas. Проверите је у Подешавања -> Напредно.",
};
